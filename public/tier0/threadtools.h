...
#if defined( _LINUX ) || defined( _OSX ) || defined(PLATFORM_BSD) || defined(PLATFORM_PSVITA)
#define USE_INTRINSIC_INTERLOCKED
...
#if defined(WIN32) || defined(OSX) ||  defined( _PS3 ) || ( defined (_LINUX) ) || defined(PLATFORM_BSD) || defined(PLATFORM_PSVITA)
